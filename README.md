...
Project follows functional programming best practices with scaleabla monorepo. <br /><br />It has a vey high bar in [mutation](mutation.app), [e2e](https://www.cypress.io), [property](https://github.com/dubzzz/fast-check) and [performance](https://clinicjs.org) testing cross platform.
