...
export type reportResultType = 'relative' | 'main'
...
export const partners = ['getdazn', 'stryker-mutator', 'monolisaapp']
...
export type withmonolisaType = {
  mainmonolisa: monolisaType
  relativemonolisa: monolisaType
}

export type repositoryType = {
  id: string
  installationId: string
  monolisa?: withmonolisaType
  repo: string
  owner: string
  private: boolean
} & withTimeStamps
...
export type reportThresholdsType = {
  high?: number
  low?: number
  break?: number
}
...
export type reportItemType = {
  ...
  thresholds?: reportThresholdsType
...
export type reportType = {
  repositoryId: string
  originalReport: reportItemType
  mainReport: reportItemType
  relativeReport: reportItemType
